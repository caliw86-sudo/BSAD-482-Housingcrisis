...
## Figure 1: Average 1-Bedroom Rent Trend (2014–2024)
...
## Figure 2: Net Housing Supply vs. Population Growth
...
## Figure 3: Net Housing Supply vs. Average Rent 
...
## Figure 4: Population Growth vs. Net Housing Supply
...
If the City of North Vancouver continues with its current approach to housing development, the system will follow the same Limits to Growth pattern observed in the data. Population growth of approximately 1.2–1.5% annually will continue to increase housing demand, placing sustained upward pressure on rent levels. Based on historical trends showing average rent increases of 4–6% per year, 1-bedroom rents could rise from approximately $1,850 in 2024 to $2,500–$2,900 by 2034 under this scenario.

The balancing loop (B1) will remain constrained by approval delays and neighbourhood opposition. Even as developers respond to strong market signals, permitting timelines of 18–24 months will continue to limit how quickly new units reach the market. Housing supply may increase in certain years but will remain volatile, averaging 300–500 net new units annually—insufficient to close the gap with demand.

Key uncertainties include provincial policy changes that could override local zoning and potential economic downturns that reduce construction activity. Unintended consequences of inaction include accelerated displacement of lower-income renters, a shrinking labour pool as workers cannot afford to live locally, and increased commuter traffic as residents are pushed to more affordable areas outside the city. This scenario offers the weakest affordability outcomes.

### Scenario 2: Moderate Densification Strategy
If the City implements a moderate densification strategy—expanding permissions for duplexes, triplexes, and secondary suites in select neighbourhoods—the system begins to shift, but key constraints remain. Housing construction becomes more consistent, potentially increasing net supply to 500–700 units annually. This strengthens the balancing loop (B1) and begins to moderate rent growth.

Over a 5–10 year period, rent increases could slow to 2–4% annually rather than 4–6%, resulting in projected 1-bedroom rents of $2,200–$2,500 by 2034. While this represents meaningful improvement over the status quo, affordability pressures persist, particularly for households earning below median income. The reinforcing demand loop (R1) remains active as population growth continues.

Key uncertainties include the consistency of policy implementation across different neighbourhoods and whether infrastructure investments keep pace with new development. Unintended consequences may include localized gentrification effects if new housing is primarily market-rate, infrastructure strain in targeted corridors that were not designed for increased density, and political friction if densification is perceived as benefiting some neighbourhoods while burdening others. This scenario improves conditions but does not resolve the underlying imbalance.

### Scenario 3: Aggressive Densification and Process Reform
If the City adopts an aggressive densification strategy combined with streamlined approval processes, the structure of the system shifts more significantly. This scenario involves city-wide expansion of missing-middle zoning, reduction of permitting timelines from 18–24 months to 8–12 months, and proactive infrastructure investment in high-growth areas.

These changes strengthen the balancing loop (B1) substantially. Housing construction could increase to 800–1,200 net new units annually, approaching the pace needed to match demand growth. Over 10 years, this could reduce the demand-supply gap by 40–60%, slowing rent growth to 1–2% annually. Projected 1-bedroom rents under this scenario would reach approximately $2,000–$2,200 by 2034—a meaningful improvement in affordability relative to other scenarios.

Key uncertainties include the political feasibility of city-wide zoning reform, construction industry capacity to scale up, and whether provincial or federal funding supports infrastructure needs. Unintended consequences may include organized political backlash from homeowner groups that could reverse policy gains in future election cycles, construction quality concerns if approvals are rushed without adequate oversight, and short-term neighbourhood disruption during construction phases. Despite these risks, this scenario offers the strongest pathway to rebalancing the system and improving long-term affordability.
